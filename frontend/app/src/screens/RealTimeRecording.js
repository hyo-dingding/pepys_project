...
const RealTimeRecording = ({ route }) => {
        ...
        try {
            ...
            await newRecording.prepareToRecordAsync({
                android: {
                    ...
                    audioEncoder:
                        Audio.RECORDING_OPTION_ANDROID_AUDIO_ENCODER_PCM,
                    sampleRate: 16000,
                    numberOfChannels: 1,
                    bitRate: 256000,
                },
    ...
    const renderHeader = () => (
        <View style={styles.header}>
            <View
                style={[styles.headerTop, !isHost && styles.participantHeader]}
            >
                {isHost && (
                    <TouchableOpacity
                ...
                <View
                    style={[styles.roomInfo, !isHost && styles.centerRoomInfo]}
                >
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.stopModalContent}>
                        <Text style={styles.stopModalTitle}>
                            End Recording?
                        </Text>
                        <Text style={styles.stopModalText}>
                            Recording will be stopped and summarized. Do you
                            want to continue?
                        </Text>
                        <View style={styles.stopModalButtons}>
                            <TouchableOpacity
                                style={[
                                    styles.stopModalButton,
                                    styles.stopModalCancelButton,
                                ]}
                                onPress={() => setShowStopModal(false)}
                            >
                                <Text style={styles.stopModalCancelText}>
                                    Cancel
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                    ...
                    <View style={styles.shareModalContent}>
                        ...
                        <View style={styles.roomCodeDisplay}>
                            ...
                            <View style={styles.roomCodeContainer}>
                                <Text style={styles.roomCodeDisplayText}>
                                    {roomCode}
                                </Text>
                                <TouchableOpacity
                                    onPress={() =>
